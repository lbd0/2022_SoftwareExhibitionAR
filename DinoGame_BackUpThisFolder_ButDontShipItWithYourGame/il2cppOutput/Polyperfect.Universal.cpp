...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Polyperfect.Universal.MouseLook::Start()
...
// System.Void Polyperfect.Universal.MouseLook::Update()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MouseLook_Update_mDE4208BEFE5A3C3D4C905D0DCDD9221F5E838337 (MouseLook_t9BD81DEEDE6704673A3EAFF3F86595672FAEB678* __this, const RuntimeMethod* method) 
{
	...
	float V_1 = 0.0f;
	{
		...
		float L_3 = __this->___mouseSensitivity_4;
		V_1 = ((float)il2cpp_codegen_multiply(L_2, L_3));
		// xRotation -= mouseY;
		float L_4 = __this->___xRotation_6;
		float L_5 = V_1;
		__this->___xRotation_6 = ((float)il2cpp_codegen_subtract(L_4, L_5));
...
// System.Void Polyperfect.Universal.MouseLook::.ctor()
...
{
	{
		...
		__this->___mouseSensitivity_4 = (3.0f);
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void Polyperfect.Universal.PlayerMovement::Update()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerMovement_Update_mE2E8AE350A6B01A9C8278D454A364ECEF4B56D3E (PlayerMovement_t2D4A6922CCE0272E201E64D6AB1AA663587F5F42* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_2), 0, sizeof(V_2));
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_1 = __this->___groundCheck_8;
		NullCheck(L_1);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_2;
		L_2 = Transform_get_position_m69CD5FA214FDAE7BB701552943674846C220FDE1(L_1, NULL);
		float L_3 = __this->___groundDistance_9;
		LayerMask_t97CB6BDADEDC3D6423C7BCFEA7F86DA2EC6241DB L_4 = __this->___groundMask_10;
		int32_t L_5;
		...
		__this->___isGrounded_12 = L_6;
		// if (isGrounded && velocity.y < 0)
		bool L_7 = __this->___isGrounded_12;
		if (!L_7)
		{
			goto IL_006d;
		}
	...
	}
	{
		...
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_10 = __this->___controller_4;
		NullCheck(L_10);
		CharacterController_set_slopeLimit_mB77021F6C5D049ED76EEBB2556562BF2BBD6C1E0(L_10, (45.0f), NULL);
		// velocity.y = -2f;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_11 = (&__this->___velocity_11);
		L_11->___y_3 = (-2.0f);
	}
...
IL_00c7:
	...
	{
		bool L_35 = __this->___isGrounded_12;
		if (!L_35)
		{
			goto IL_0130;
		}
	}
	{
		...
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_36 = __this->___controller_4;
		NullCheck(L_36);
		CharacterController_set_slopeLimit_mB77021F6C5D049ED76EEBB2556562BF2BBD6C1E0(L_36, (100.0f), NULL);
		// velocity.y = Mathf.Sqrt(jumpHeight * -2f * gravity);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2* L_37 = (&__this->___velocity_11);
		float L_38 = __this->___jumpHeight_7;
		float L_39 = __this->___gravity_6;
		float L_40;
...
IL_0130:
	{
		...
		float L_45 = __this->___gravity_6;
		float L_46;
		...
		*((float*)L_43) = (float)((float)il2cpp_codegen_add(L_44, ((float)il2cpp_codegen_multiply(L_45, L_46))));
		...
		CharacterController_t847C1A2719F60547D7D6077B648D6CE2D1EF3A6A* L_47 = __this->___controller_4;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_48 = __this->___velocity_11;
		float L_49;
...
// System.Void Polyperfect.Universal.PlayerMovement::.ctor()
